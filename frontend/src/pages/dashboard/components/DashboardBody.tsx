          ...
          <form className="overflow-y-auto lg:max-h-[60rem] 2xl:max-h-fit">
            <article className="mb-5">
              ...
              <p className="mb-2 text-gray-900 dark:text-white">
                ...
                Let's schedule a kick-off meeting and workshop this week. It would be great to gather everyone involved in the design
            ...
            <article className="mb-5">
              ...
              <p className="mb-2 text-gray-900 dark:text-white">
                Thank you for the workshop, it was very productive meeting. I can't wait to start working on this new project with you guys.
                But first things first, I'am waiting for the offer and pitch deck from you. It would be great to get it by the end o the
                month.
              </p>
            ...
            <article className="mb-5">
              ...
              <p className="mb-2 text-gray-900 dark:text-white">
                ...
                I'am attaching our offer and pitch deck. Take your time to review everything. I'am looking forward to the next steps! Thank
                you.
              </p>
              <p className="mb-3 text-gray-900 dark:text-white">Looking forward to it! Thanks.</p>
            ...
            <div className="relative mx-auto overflow-hidden h-[36rem] lg:h-[24rem]">
              <div className="hidden duration-700 ease-in-out bg-white dark:bg-gray-800" data-carousel-item>
                ...
                <p className="mb-4 text-gray-500 dark:text-gray-400">
                  Get started with a free and open-source admin dashboard layout built with Tailwind CSS and Flowbite featuring charts,
